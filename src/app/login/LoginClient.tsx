    ...
    return (
      <div className="grid min-h-[80vh] place-items-center px-4 py-12">
        <div className="glass w-full max-w-md rounded-2xl p-6 text-center">
          ...
          <p className="mt-3 text-sm leading-6 text-white/55">Continue to your Noir Closet workspace.</p>
    ...
    <div className="grid min-h-[80vh] place-items-center px-4 py-12">
      {hasClerk ? (
        ...
        <div className="glass w-full max-w-md rounded-2xl p-6">
          ...
          <h1 className="mt-3 text-3xl font-semibold">Sign in to Noir Closet</h1>
          <div className="mt-6 grid gap-4">
            <input id="login-email" name="email" type="email" autoComplete="email" aria-label="Email" className="rounded-xl border border-white/10 bg-black/40 px-4 py-3 outline-none focus:border-white/35" placeholder="Email" />
            <input id="login-password" name="password" type="password" autoComplete="current-password" aria-label="Password" className="rounded-xl border border-white/10 bg-black/40 px-4 py-3 outline-none focus:border-white/35" placeholder="Password" />
